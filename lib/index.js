...
const httpChatKernelPlugin = {
    ...
    activate: async (app, kernelspecs) => {
        ...
        try {
            const readiness = [];
            const serviceReady = app.serviceManager?.ready;
            if (serviceReady) {
        ...
        kernelspecs.register({
            ...
            create: async (options) => {
                ...
                return Promise.resolve((0, kernel_2.createHttpLiteKernel)(options));
            },
        });
